...
# implementing the Rock, Scissor, Paper game with Regret Matching
class RPS:
...
class Player:
    ...
    def regret(self, my_action, opp_action):
        ...
        """
        print('INIZIA LA REGRET')
        result = RPS.utilities.loc[my_action, opp_action]
        print(result, my_action, opp_action)
    ...
    def play(self, avg_regret_matching=False):
        def play_regret_matching():
            for i in range(0, self.max_game):
                ...
                print(game.p1.avg_strategy)
                print(game.p1.regret_sum)
...
if __name__ == '__main__':
    ...
    print('Player 1 Data')
    print(game.p1.strategy, game.p1.regret_sum)
    print('Player 2 Data')
    print(game.p2.strategy, game.p2.regret_sum)
